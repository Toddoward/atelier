    ...
    fn round_trips_embedded_smart_object() {
        ...
        let mut add_s = AddNode::new(
            ...
            Node::new(
                ...
                NodeKind::Smart(SmartContent { doc: Box::new(inner), offset: [4, 6], scale: [1.0, 1.0], rotation: 0.0 }),
            ),
            root,
            0,
        );
    ...
    fn round_trips_nested_smart_object() {
        ...
        let mut b = AddNode::new(
            ...
            Node::new(
                ...
                NodeKind::Smart(SmartContent { doc: Box::new(deep), offset: [1, 1], scale: [1.0, 1.0], rotation: 0.0 }),
            ),
            mroot,
            0,
        );
        ...
        let mut c = AddNode::new(
            ...
            Node::new(
                ...
                NodeKind::Smart(SmartContent { doc: Box::new(mid), offset: [2, 2], scale: [1.0, 1.0], rotation: 0.0 }),
            ),
            root,
            0,
        );
